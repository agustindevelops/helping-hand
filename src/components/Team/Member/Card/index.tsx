  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
      ...
      <div className="p-6">
        ...
        <p className="mt-3 text-gray-600 text-sm">{quote}</p>
        <div className="mt-4 flex space-x-3">
          {twitterUrl && (
            <a href={twitterUrl} className="text-gray-400 hover:text-indigo-600">
          ...
          {linkedinUrl && (
            <a href={linkedinUrl} className="text-gray-400 hover:text-indigo-600">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          {githubUrl && (
            <a href={githubUrl} className="text-gray-400 hover:text-indigo-600">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
